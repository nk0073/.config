...
/*
 *
 *  TODO: change `kscrollup` and `kscrolldown` 
 *  to use float values for going up and down (they are used in many places)
 *
 */
...
static Shortcut shortcuts[] = {
	...
	{ MODKEY | ShiftMask,   XK_K,     kscrollup,       {.i = -1}, S_PRI },
	{ MODKEY | ShiftMask,   XK_J,   kscrolldown,       {.i = -1}, S_PRI },
